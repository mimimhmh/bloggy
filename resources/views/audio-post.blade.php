					...
					<article class="post">
						<header>
							<div class="title">
								...
								<p>Leo ipsum dolor amet nullam consequat etiam feugiat</p>
							</div>
							<div class="meta">
						...
						<div class="blog-audio blog-media">
							<iframe  src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/309689093&amp;auto_play=false&amp;hide_related=false&amp;show_comments=true&amp;show_user=true&amp;show_reposts=false&amp;visual=true"></iframe>
						</div>
						<p>Mauris neque quam, fermentum ut nisl vitae, convallis maximus nisl. 
							...
							<blockquote><p>Stet clita kasd gubergren, no sea takimata sanctus est Leo ipsum dolor sit amet vultatup duista.</p></blockquote>
							...
							<p>Leo ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum.</p>
							<p><code>Stet clita kasd gubergren, no sea takimata sanctus est Leo ipsum dolor sit amet.</code></p>
							<p>Leo ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Leo ipsum dolor sit amet.</p>
							<div class="note">
								<ol>
									<li>Leo ipsum</li>
							...
							<div class="related">
								<ul class="row">
									<li class="item col-lg-4 col-md-4 col-sm-4">
										<div class="thumb">
											<a href="#"><img src="images/relate-post01.jpg" alt="post relate"></a>
										</div>
										<h5 class="item-title">
									...
									<li class="item col-lg-4 col-md-4 col-sm-4">
										<div class="thumb">
											<a href="#"><img src="images/relate-post02.jpg" alt="post relate"></a>
										</div>
										<h5 class="item-title">
											<a href="#">Seitan High Life reprehenderit consectetur cupidatat kogi</a>
										</h5>
									...
									<li class="item col-lg-4 col-md-4 col-sm-4">
										<div class="thumb">
											<a href="#"><img src="images/relate-post03.jpg" alt="post relate"></a>
										</div>
										<h5 class="item-title">
											<a href="#">Seitan High Life reprehenderit consectetur cupidatat kogi</a>
										</h5>
						...
						<div class="blog-comments">
							<div class="blog-comment-main">
								...
								<div class="blog-comment">
									<a class="comment-avtar"><img src="images/avtar-comment.jpg" alt="image"></a>
									...
									<div class="blog-comment clearfix">
										...
										<div class="comment-text">
											<h3>Edward Doe</h3>
											<h5>Avril 13, 2017 at 21:11 am</h5>
											<p>using Leo Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable English.</p>
											<a href="javascript:void(0)" class="comment-reply"> Reply <i class="fa fa-angle-right" aria-hidden="true"></i> </a>
										</div>
									</div>
								</div>
								<div class="blog-comment">
									...
									<div class="comment-text">
										<h3>CATHERINE DOE</h3>
										<h5>Avril 13, 2017 at 21:11 am</h5>
										<p>packages and web page editors now use Leo Ipsum as their default model text, and a search for 'lorem ipsum' will uncover many web site</p>
										<a href="javascript:void(0)" class="comment-reply"> Reply <i class="fa fa-angle-right" aria-hidden="true"></i> </a>
									</div>
									<div class="blog-comment clearfix">
										<a class="comment-avtar"><img src="images/avtar-comment.jpg" alt="image"></a>
							...
							<section>
								...
								<div class="mini-posts">
									...
									<article class="mini-post">
										...
										<a href="#" class="image"><img src="images/side-post01.jpg" alt="" /></a>
									</article>
									...
									<article class="mini-post">
										...
										<a href="#" class="image"><img src="images/side-post02.jpg" alt="" /></a>
									</article>
									...
									<article class="mini-post">
										...
										<a href="#" class="image"><img src="images/side-post03.jpg" alt="" /></a>
									</article>
								...
								<ul class="posts">
									<li>
										<article>
											...
											<a href="#" class="image"><img src="images/small-side-post01.jpg" alt="" /></a>
										</article>
									</li>
									<li>
										<article>
											...
											<a href="#" class="image"><img src="images/small-side-post02.jpg" alt="" /></a>
										</article>
									</li>
									<li>
										<article>
											...
											<a href="#" class="image"><img src="images/small-side-post03.jpg" alt="" /></a>
										</article>
									</li>
									<li>
										<article>
											...
											<a href="#" class="image"><img src="images/small-side-post04.jpg" alt="" /></a>
										</article>
									</li>
								</ul>
							</section>
								...
								<div class="widget HTML">
									...
									<div class="widget-content">
										<div class="instagram-feeds row-gallery">
											<a href="#" class="col-sm-4 col-xs-3"><img src="images/instagram01.jpg" alt="Instagram Image"></a>
											<a href="#" class="col-sm-4 col-xs-3"><img src="images/instagram02.jpg" alt="Instagram Image"></a>
											<a href="#" class="col-sm-4 col-xs-3"><img src="images/instagram03.jpg" alt="Instagram Image"></a>
											<a href="#" class="col-sm-4 col-xs-3"><img src="images/instagram04.jpg" alt="Instagram Image"></a>
											<a href="#" class="col-sm-4 col-xs-3"><img src="images/instagram05.jpg" alt="Instagram Image"></a>
											<a href="#" class="col-sm-4 col-xs-3"><img src="images/instagram06.jpg" alt="Instagram Image"></a>
											<a href="#" class="col-sm-4 col-xs-3"><img src="images/instagram07.jpg" alt="Instagram Image"></a>
											<a href="#" class="col-sm-4 col-xs-3"><img src="images/instagram08.jpg" alt="Instagram Image"></a>
											<a href="#" class="col-sm-4 col-xs-3"><img src="images/instagram09.jpg" alt="Instagram Image"></a>
										</div>
									</div>
								</div>
							</section> <!-- End inta -->
