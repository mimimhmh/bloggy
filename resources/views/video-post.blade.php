				...
				<div class="col-md-8">
					...
					<article class="post">
						...
						<div class="format-video">
							<iframe src="https://www.youtube.com/embed/nrJtHemSPW4?rel" allowfullscreen></iframe>
						</div>
							...
							<div class="blog-comment-main">
								...
								<div class="blog-comment">
									...
									<div class="blog-comment clearfix">
										...
										<div class="comment-text">
											<h3>Edward Doe</h3>
											<h5>Avril 13, 2017 at 21:11 am</h5>
											<p>using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable English.</p>
											<a href="javascript:void(0)" class="comment-reply"> Reply <i class="fa fa-angle-right" aria-hidden="true"></i> </a>
										</div>
									</div>
								</div>
								<div class="blog-comment">
									...
									<div class="comment-text">
										<h3>CATHERINE DOE</h3>
										<h5>Avril 13, 2017 at 21:11 am</h5>
										<p>packages and web page editors now use Lorem Ipsum as their default model text, and a search for 'lorem ipsum' will uncover many web site</p>
										<a href="javascript:void(0)" class="comment-reply"> Reply <i class="fa fa-angle-right" aria-hidden="true"></i> </a>
									</div>
									<div class="blog-comment clearfix">
										<a class="comment-avtar"><img src="images/avtar-comment.jpg" alt="image"></a>
