        ...
        <div class="row">
            <div class="full">
                <ul class="quick-link">
                    ...
                    <li><a target="_blank"><i class="fa fa-vimeo-square"></i> </a></li>
                    <li><a target="_blank"><i class="fa fa-rss"></i> </a></li>

                </ul>

                <div class="copy-right">
                    <p>copyright,&copy; 2017 - All Rights Reserved. <a href="#">J Wang</a></p>
                </div>
            </div>
        </div>
    </div>
