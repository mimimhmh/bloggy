...
@section('content')
    <article class="post">
        <header>
            <div class="title">
                <h2><a href="#">Video Example Post</a></h2>
                <p>Lorem ipsum dolor amet nullam consequat etiam feugiat</p>
            </div>
            <div class="meta">
                <time class="published" datetime="2017-01-14">November 1, 2017</time>
                <a href="#" class="author"><span class="name">Jay Wang</span><img src="images/default-avatar.png" alt="" /></a>
            </div>
        </header>
        <div class="format-video">
            <iframe src="https://www.youtube.com/embed/R9RX4E29fOI" frameborder="0"  allowfullscreen></iframe>
        </div>
